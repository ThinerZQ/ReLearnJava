 ...
 * 
 */
@WebServiceClient(name = "webserviceService", targetNamespace = "http://webservice.zq.com/", wsdlLocation = "http://localhost:8888/WebServiceTest/webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVICE_QNAME = new QName("http://webservice.zq.com/", "webserviceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/WebServiceTest/webservice?wsdl");
    ...
    public Webservice getWebservicePort() {
        return super.getPort(new QName("http://webservice.zq.com/", "webservicePort"), Webservice.class);
    }
    ...
    public Webservice getWebservicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.zq.com/", "webservicePort"), Webservice.class, features);
    }
